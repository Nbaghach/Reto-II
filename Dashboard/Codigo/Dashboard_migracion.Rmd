...
# Carga de datos (USANDO NOMBRES REALES DE TU BASE FINAL)
...
```{r}
## 4) Mapa (choropleth Plotly) — ahora por **ISO-3** real
...
renderPlotly({
  ...
  # Base completa (para modo "sin filtros")
  base <- d_year %>%
    transmute(
      iso3 = iso3,
      country = country,
